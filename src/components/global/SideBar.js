    ...
    <div className="side-bar flex-col-center orange-bg">
      <PerfectScrollbar className="side-bar--cont flex-col-top-start">
        <NavLink end to={'/admin-panel/'}>
          <i className={`bi bi-house-door margin-8px-V size-24px ${mode === 'dark-mode' ? 'gray' : 'white'} size-24px`} /><span className={`side-bar--cont--description inter size-20px ${mode === 'dark-mode' ? 'gray' : 'white'}`}>Home</span>
        </NavLink>
        <NavLink to={'/admin-panel/admins'} >
          <i className={`bi bi-person-square margin-8px-V ${mode === 'dark-mode' ? 'gray' : 'white'} size-24px`} /><span className={`side-bar--cont--description inter size-20px ${mode === 'dark-mode' ? 'gray' : 'white'}`}>Admins</span>
        </NavLink>
        <NavLink to={'/admin-panel/stores'} >
          <i className={`bi bi-shop-window margin-8px-V ${mode === 'dark-mode' ? 'gray' : 'white'} size-24px`} /><span className={`side-bar--cont--description inter size-20px ${mode === 'dark-mode' ? 'gray' : 'white'}`}>Stores</span>
        </NavLink>
        <NavLink to={'/admin-panel/customers'} >
          <i className={`bi bi-people margin-8px-V ${mode === 'dark-mode' ? 'gray' : 'white'} size-24px`} /><span className={`side-bar--cont--description inter size-20px ${mode === 'dark-mode' ? 'gray' : 'white'}`}>Customers</span>
        </NavLink>
        <NavLink to={'/admin-panel/specialty'} >
          <i className={`bi bi-patch-check margin-8px-V ${mode === 'dark-mode' ? 'gray' : 'white'} size-24px`} /><span className={`side-bar--cont--description inter size-20px ${mode === 'dark-mode' ? 'gray' : 'white'}`}>Specialty</span>
        </NavLink>
        <NavLink to={'/admin-panel/products'} >
          <i className={`bi bi-box-seam margin-8px-V ${mode === 'dark-mode' ? 'gray' : 'white'} size-24px`} /><span className={`side-bar--cont--description inter size-20px ${mode === 'dark-mode' ? 'gray' : 'white'}`}>Products</span>
        </NavLink>
        <NavLink to={'/admin-panel/orders'} >
          <i className={`bi bi-receipt margin-8px-V ${mode === 'dark-mode' ? 'gray' : 'white'} size-24px`} /><span className={`side-bar--cont--description inter size-20px ${mode === 'dark-mode' ? 'gray' : 'white'}`}>Orders</span>
        </NavLink>
        <NavLink to={'/admin-panel/ordersHistory'} >
          <i className={`bi bi-hourglass-split margin-8px-V ${mode === 'dark-mode' ? 'gray' : 'white'} size-24px`} /><span className={`side-bar--cont--description inter size-20px ${mode === 'dark-mode' ? 'gray' : 'white'}`}>Orders History</span>
        </NavLink>
        <NavLink to={'/admin-panel/drivers'} >
          <i className={`bi bi-truck margin-8px-V ${mode === 'dark-mode' ? 'gray' : 'white'} size-24px`} /><span className={`side-bar--cont--description inter size-20px ${mode === 'dark-mode' ? 'gray' : 'white'}`}>Drivers</span>
        </NavLink>
