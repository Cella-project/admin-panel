        ...
        <form noValidate className="edit-category" onSubmit={formSubmissionHandler}>
            <div className="full-width flex-col-left-start edit-category--input-container">
                <div className="full-width flex-col-left-start edit-category--input-container">
                    ...
                    <button
                        type="button"
                        className={`edit-category--actions--button${subCategory === 'No Image' ? '-hide' : ''} margin-4px-V full-width pointer radius-10px shadow-4px ${mode === 'dark-mode' ? 'gray' : 'white'} text-shadow size-18px font-bold mint-green-bg`}
