        ...
        <div className="flex-row-left-start gray ">
          <div className="flex-col-center ">
            <div className="flex-row-center ">
              Subtotal :
              <div className={`flex-row-center ${mode === 'dark-mode' ? 'gray' : 'orange'} size-18px margin-2px-H`}>{order.subTotal} EGP</div>
            </div>
            <div className="flex-row-center order-info-money">
              Delivery Fee :
              <div className={`flex-row-center ${mode === 'dark-mode' ? 'gray' : 'orange'} size-18px margin-2px-H`}> {order.deliveryFee} EGP</div>
            </div>
            <div className="flex-row-center">
              Total Cost :
              <div className={`flex-row-center ${mode === 'dark-mode' ? 'gray' : 'orange'} size-24px margin-2px-H`}> {order.total} EGP</div>
            </div>
          </div>
        </div>
      </div>
